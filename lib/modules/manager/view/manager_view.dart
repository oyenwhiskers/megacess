...
class ManagerView extends StatefulWidget {
  ...
  const ManagerView({Key? key, this.managerName = 'manager_name'}) : super(key: key);
                        ...
                        : Column(
                            children: [
                                  ...
                                  child: Column(
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          Text('Total Tasks', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                                          SizedBox(width: 6),
                                          Icon(Icons.calendar_today, size: 18, color: Colors.grey[700]),
                                        ],
                                      ),
                                      SizedBox(height: 6),
                                      Text('${analytics.totalTasks}', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold)),
                                    ],
                                  ),
                                ),
                              ),
                                  ...
                                  Expanded(
                                    child: Card(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          children: [
                                            Icon(Icons.play_arrow, color: Colors.green, size: 22),
                                            SizedBox(height: 2),
                                            Text('In-Progress', style: TextStyle(fontSize: 13)),
                                            SizedBox(height: 2),
                                            Text('${analytics.inProgress}', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                                          ],
                                        ),
                                      ),
                                    ),
                                  ...
                                  Expanded(
                                    child: Card(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          children: [
                                            Icon(Icons.pause_circle_filled, color: Colors.amber, size: 22),
                                            SizedBox(height: 2),
                                            Text('Pending', style: TextStyle(fontSize: 13)),
                                            SizedBox(height: 2),
                                            Text('${analytics.pending}', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: Colors.amber)),
                                          ],
                                        ),
                                      ),
                                    ),
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          children: [
                                            ...
                                            SizedBox(height: 2),
                                            Text('${analytics.rejected}', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: Colors.red)),
                                          ],
                                        ),
                                      ),
                                    ),
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          children: [
                                            ...
                                            SizedBox(height: 2),
                                            Text('${analytics.completed}', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: Colors.green)),
                                          ],
                                        ),
                                      ),
                                    ),
                              ...
                              Card(
                                ...
                                color: Colors.white,
                                child: ListTile(
                                  leading: Icon(Icons.groups, color: Colors.teal, size: 26),
                                  title: Text('My Staff', style: TextStyle(fontSize: 15)),
